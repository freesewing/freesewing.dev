  ...
  return (
    <React.Fragment>
      <p>
        ...
        <a href={'https://github.com/freesewing/' + repo} title="Contributors" style={styles.badge}>
          <img
      ...
      <ul className="links">
        <li>
          <a href={'https://github.com/freesewing/' + repo}>freesewing/{repo} on GitHub</a>
        </li>
        <li>
          <a href={'https://github.com/freesewing/' + repo + '/issues'}>freesewing/{repo} Issues</a>
        </li>
        <li>
          <a href={'https://github.com/freesewing/' + repo + '/pulls'}>
            freesewing/{repo} Pull requests
          </a>
        </li>
      </ul>
    </React.Fragment>
